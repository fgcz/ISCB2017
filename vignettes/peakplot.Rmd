...
peptide_search <- function(x, peptides, pimIdx=parentIonMass(peptides), peptideMassTolerancePPM=5){
  query.mass <- ((x$pepmass  * x$charge))  - (1.0027 * (x$charge-1))
  eps <- query.mass * massTolPPM * 1E-6
