...
## ----fig.cap="number of PSMs per protein"--------------------------------
...
## ----fig.cap="nr. of proteins matched by one peptide"--------------------
...
## ----fig.cap="length of peptide vs # proteins matched"-------------------
...
## ----plotPrecursorLevel, fig.cap="Precursor level score distribution"----
...
## ----plotModPeptideLevel, fig.cap="Peptide level score distribution"-----
...
## ----plotPeptideLevel, fig.cap="Peptide level score distribution"--------
...
## ----proteinLevel, fig.cap="Protein level score distribution"------------
...
## ----proteinLevel2, fig.cap="Protein level score distribution"-----------
